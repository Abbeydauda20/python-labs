...
# print(mountains)
# To add an entry to the end of a list we use apend
# print(mountains.append("oregon mountain"))
# print(mountains)

# # Extend the existing list with new list of items or multiple items to the end of a list
...
# # This removes a certain item e.g. k2
